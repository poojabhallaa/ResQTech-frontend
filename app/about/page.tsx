  ...
  return (
    <>
      ...
      <section className="py-20 px-6 md:px-10 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="bg-[#3e7191] hover:bg-[#669BBC] text-white text-4xl rounded-[0.3rem] mb-5 p-3 font-semibold">Our Team</Badge>
            <h2 className="text-3xl md:text-5xl font-bold text-[#003049] mb-5">Meet the Minds Behind ResQ-Tech</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our diverse team combines expertise in AI, emergency management, and humanitarian response to create
            ...
            {[
              {
                name: "Aditya Singh",
                role: "ML Engineer",
                bio: "BCA 3rd year, SRM Institute of Science and Technology, Delhi NCR Campus.",
                image: "/adi.jpeg",
              },
              {
                name: "Anikesh Kumar",
                role: "Full-Stack Developer",
                bio: "B.tech (CSE) 2nd year, Meri College of Engineering & Technology.",
                image: "/ak.jpeg",
              },
              {
                name: "N.Aarwin",
              ...
              },
              {
                name: "Aryan Jha",
                role: "ML Engineer",
                bio: "B.Tech (IT) 1st year, Dr.Akhilesh Das Gupta Institute of Professional Studies.",
                image: "/raj.jpeg",
              },
              {
              ...
              },
              {
                name: "Koshal Yadav",
                role: "Ui/Ux Designer",
                bio: "BCA 2nd year, Meri College of Engineering & Technology.",
                image: "/kos.jpeg",
              },
              {
                name: "Swayam Jha",
                role: "Iot Engineer",
                bio: "B.tech (ECE) 1st year, Vivekananda Institute of Professional Studies.",
                image: "/swa.jpeg",
              },
              {
                name: "Join Us",
                role: "Ai/Ml, Blockchain, IoT",
                bio: "Excited to collaborate — join us and make an impact together!",
                image: "/join.png",
              },
            ].map((member, index) => (
              <Card
              ...
              >
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-[#003049]">{member.name}</h3>
                  <p className="text-[#C1121F] font-medium mb-2">{member.role}</p>
